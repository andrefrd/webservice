...
class Smartwave_Porto_Model_Cssconfig_Generator extends Mage_Core_Model_Abstract{ 
    ...
    protected function generateStoreCss($type, $storeCode){
        ...
        try{ 
            ...
            Mage::getSingleton('adminhtml/session')->addError(Mage::helper('porto')->__('Failed generating CSS file: %s in %s', $x12, Mage::helper('porto/cssconfig')->getCssConfigDir()). '<br/>Message: ' . $e->getMessage()); 
            Mage::logException($e);
        }
